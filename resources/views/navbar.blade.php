<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">JMLG Panel</a>
    </div>
     <div id="navbar" class="navbar-collapse collapse">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdonw">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Cerveza<span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="">Cervezas</a></li>
            <li><a href="">Nueva Cerveza</a></li>
          </ul>
        </li>
      </ul>
    </div><!--/.nav-collapse -->
